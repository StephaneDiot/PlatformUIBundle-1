...
YUI.add('ez-date-editview-tests', function (Y) {
    var viewTest, registerTest, getFieldTest, getEmptyFieldTest, getFieldTestOldBrowsers, getEmptyFieldTestOldBrowsers;
    ...
    viewTest = new Y.Test.Case({
        ...
        "Test validate no constraints new browsers": function () {
            ...
            this.view.set('fieldDefinition', fieldDefinition);
            this.view._set('isSupportingHTML5', true);
            this.view.render();
        ...
        "Test validate no constraints old browsers": function () {
            ...
            this.view.set('fieldDefinition', fieldDefinition);
            this.view._set('isSupportingHTML5', false);
            this.view.render();
        ...
        "Test calendar update old browsers": function () {
            ...
            Y.Assert.isNull(Y.Date.parse(this.view.get('calendar').get('selectedDates')),
                'Calendar should NOT have a selected date if input is empty ');
    ...
    getFieldTestOldBrowsers = new Y.Test.Case(
        Y.merge(Y.eZ.Test.GetFieldTests, {
            ...
            _setNewValue: function () {
                this.view.set('isSupportingHTML5', false);
    ...
    Y.Test.Runner.add(getFieldTestOldBrowsers);
    ...
    getFieldTest = new Y.Test.Case(
        Y.merge(Y.eZ.Test.GetFieldTests, {
            ...
            _setNewValue: function () {
                this.view.set('isSupportingHTML5', true);
                this.view.get('container').one('input').set('value', this.filledValue);
            },
